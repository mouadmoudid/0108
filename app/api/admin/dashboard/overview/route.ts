...
export async function GET(request: NextRequest) {
  // Vérifier que l'utilisateur est ADMIN UNIQUEMENT (pas Super Admin)
  ...
  try {
    // Récupération des données du dashboard pour l'admin
    // Un admin ne voit que les données de sa propre laundry
    ...
    // Données du dashboard pour cette laundry spécifique
